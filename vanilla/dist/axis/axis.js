...
const canvasX = document.getElementById("canvas_xAxis");
const canvasY = document.getElementById("canvas_yAxis");
...
export const updateAxisX = (scale, offset, divs) => {
...
export const updateAxisY = (scale, offset, divs) => {
    if (ctxY) {
